...
const DiscoverNewsletter = () => {
  ...
  return (
    <form className="flex max-md:block items-center mt-4 gap-3 bg-black fixed bottom-20 p-4" onSubmit={handleSubmit}>
...
export default DiscoverNewsletter;
